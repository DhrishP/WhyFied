    ...
    <div className="font-semibold bg-orange-100 pt-5 text-lg flex items-center justify-center flex-col lg:px-72 px-6 space-y-4">
      ...
      <div className="flex flex-col space-y-2 text-[1rem]">
        ...
        <p>
          ...
          promoted and consumed more than the things that defines you as a human
          that are
          <span className="font-extrabold text-lg"> values </span>and{" "}
          <span className="font-extrabold text-lg">purpose</span> which are
          neglected in this digitally black and white world (Resulting in rise
          of Onlyfans, Tiktok,etc.)
        </p>
        <p>
          ...
          about their life and the world around thems
          <span className="font-bold text-lg">
            (Great things and people around us were made by questioning things)
          </span>
        </p>
      </div>
